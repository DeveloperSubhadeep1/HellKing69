    ...
    #         await query.answer(url=f"https://telegram.me/{temp.U_NAME}?start=sendfiles4_{key}")
            ...
            if is_premium_only and query.from_user.id not in ADMINS and not await db.has_premium_access(query.from_user.id):
                ...
                alert_text = (
                    ...
                    "ᴛʜᴇ 'ꜱᴇɴᴅ ᴀʟʟ' ʙᴜᴛᴛᴏɴ ɪꜱ ᴀɴ ᴇxᴄʟᴜꜱɪᴠᴇ ꜰᴇᴀᴛᴜʀᴇ ꜰᴏʀ ᴏᴜʀ ✨ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪʙᴇʀꜱ ✨.\n"
                    "ᴜᴘɢʀᴀᴅᴇ ʏᴏᴜʀ ᴀᴄᴄᴏᴜɴᴛ ᴛᴏ ɪɴꜱᴛᴀɴᴛʟʏ ᴅᴏᴡɴʟᴏᴀᴅ ᴀʟʟ ꜰɪʟᴇꜱ ᴀᴛ ᴏɴᴄᴇ ᴀɴᴅ ᴇɴᴊᴏʏ ᴀɴ ᴀᴅ-ꜰʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ!\n"
                    "👉 ᴜꜱᴇ ᴛʜᴇ /ᴘʀᴇᴍɪᴜᴍ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ꜱᴇᴇ ᴏᴜʀ ᴀꜰꜰᴏʀᴅᴀʙʟᴇ ᴘʟᴀɴꜱ."
                )
                try:
